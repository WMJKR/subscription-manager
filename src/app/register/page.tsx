...
const INPUT_CLASS =
  "w-full rounded-lg border border-border-strong bg-surface px-3 py-2 text-sm text-text focus:border-primary-500 focus:outline-none";
  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <button
              ...
              className={`relative h-6 w-11 shrink-0 rounded-full transition-colors ${
                isTrial ? "bg-primary-600" : "bg-slate-300 dark:bg-slate-600"
              }`}
            >
              <span
        ...
        <div className="rounded-lg border border-border p-3">
          <div className="flex items-center justify-between gap-3">
            ...
            <button
              ...
              className={`relative h-6 w-11 shrink-0 rounded-full transition-colors ${
                isShared ? "bg-primary-600" : "bg-slate-300 dark:bg-slate-600"
              }`}
            >
              <span
                className={`absolute top-0.5 h-5 w-5 rounded-full bg-white transition-transform ${
        ...
        <div className="rounded-lg border border-border p-3">
          <p className="text-sm font-medium text-slate-700 dark:text-slate-300">결제 카드 (선택)</p>
        ...
        <button
          type="submit"
          className="w-full rounded-lg bg-primary-600 py-3 text-sm font-semibold text-white transition-colors hover:bg-primary-hover"
        >
          구독 등록하기
        </button>
      </form>
